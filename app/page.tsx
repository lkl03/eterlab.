  ...
  return (
    <main className="min-h-dvh font-body">
      ...
      <div className="mx-auto flex min-h-[calc(100dvh-64px)] w-full max-w-3xl flex-col items-center justify-center gap-6 px-6 pb-12 text-center">
        <div className="w-full max-w-70 pointer-events-none! cursor-none!">
          <Image
            src="/logo.avif"
            alt="Logo"
            width={840}
        ...
        <p className="max-w-prose text-2xl font-light leading-relaxed text-[#212121] pointer-events-none! cursor-none!">
          {COPY[lang].desc}
        </p>
